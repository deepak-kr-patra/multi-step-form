const ThankYou = () => {
    return (
        <section className="relative w-full h-full flex justify-center items-center sm:px-3 md:px-6 lg:px-16">
            <section className="liftedElement thankYouBox justify-center items-center gap-3 p-5 md:p-12 bg-white">
                <img src="/icon-thank-you.svg" alt="thankyou pic" className="thankYouImg mb-4" />
